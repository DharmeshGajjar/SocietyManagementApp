    ...
    public class ReceiptController : BaseController
    {
        ...
        public IActionResult Index(long id)
        {
            try
            {
                ...
                recPay.VouTypeList = ObjTaxMasterHelpers.GetVoucherTypeList("REC",companyId);
                ...
                Parameters[4] = new SqlParameter("@VouType", "REC");
                ...
                if (id > 0)
                {
                    ...
                    sqlParameters[4] = new SqlParameter("@VouType", "REC");
                    ...
                    if (DtRec != null && DtRec.Rows.Count > 0)
                    {
                        ...
                        if (masterId > 0)
                        {
                            ...
                            else
                            {
                                ...
                                return RedirectToAction("index", "Receipt", new { id = 0 });
                            }
                        }
                        else
                        {
        ...
        public IActionResult GetReportView(int gridMstId, int pageIndex, int pageSize, string searchValue, string columnName, string sortby)
        {
            ...
            try
            {
                ...
                string currentURL = "/Receipt/Index";
                ...
                if (DtDepartment != null && DtDepartment.Rows.Count > 0)
                {
                    ...
                    if (status == 0)
                    {
                        ...
                        getReportDataModel.ControllerName = "Receipt";
                    }
                    else
                    {
            ...
            try
            {
                if (!string.IsNullOrWhiteSpace(bookvou))
                {
                    ...
                    if (vcmvou == 0)
                        ...
                        flg = 2;
                    string value = ObjDBConnection.GetClosBalance(DbConnection.ParseInt32(bookvou), companyId, YearId, dtn, vcmvou, flg, "REC", grdAmt);
                    return Json(new { response = true, message = value });
                }
            }
            catch (Exception ex)
        ...
        public IActionResult ExportToExcelPDF(int gridMstId, string searchValue, int type)
        {
            ...
            try
            {
                ...
                if (type == 1)
                {
                    var bytes = Excel(getReportDataModel, "Receipt Report", companyDetails.CmpName);
                    return File(
                          bytes,
                ...
                {
                    var bytes = PDF(getReportDataModel, "Receipt Report", companyDetails.CmpName);
                    return File(
                          bytes,
                          "application/pdf",
                          "Receipt.pdf");
