...
{
    public class FastJVController : BaseController
    {
        ...
        public IActionResult Index(long id)
        {
            try
            {
                ...
                recPay.VouTypeList = ObjTaxMasterHelpers.GetVoucherTypeList("FJV", companyId);
                recPay.DepList = ObjTaxMasterHelpers.GetDepartmentDropdown(companyId);
                recPay.DCList = ObjAccountGroupHelpers.GetAccountCrDr();
                recPay.BookAccList = ObjTaxMasterHelpers.GetSalesAccountDropdown(companyId, 0);
                ...
                Parameters[4] = new SqlParameter("@VouType", "FJV");
                ...
                if (id > 0)
                {
                    ...
                    sqlParameters[4] = new SqlParameter("@VouType", "FJV");
        ...
        public IActionResult Index(long id, RecPayModel recPayModel)
        {
            try
            {
                ...
                recPayModel.DCList = ObjAccountGroupHelpers.GetAccountCrDr();
                ...
                recPayModel.VouTypeList = ObjTaxMasterHelpers.GetVoucherTypeList("REC", companyId);
                    ...
                    if (DtRec != null && DtRec.Rows.Count > 0)
                    {
                        ...
                        if (masterId > 0)
                        {
                            ...
                            else
                            {
                                ...
                                return RedirectToAction("index", "FastJV", new { id = 0 });
                            }
                        }
                        else
                        {
        ...
        public IActionResult Delete(long id)
        {
            try
            {
                ...
                if (id > 0)
                {
                    ...
                    {
                        SetSuccessMessage("Receipt Deleted Sucessfully");
                    }
                }
            }
            catch (Exception ex)
            ...
            return RedirectToAction("index", "FastJV");
        }
        ...
        public IActionResult GetReportView(int gridMstId, int pageIndex, int pageSize, string searchValue, string columnName, string sortby)
        {
            ...
            try
            {
                ...
                string currentURL = "/FastJV/Index";
                ...
                if (DtDepartment != null && DtDepartment.Rows.Count > 0)
                {
                    ...
                    if (status == 0)
                    {
                        ...
                        getReportDataModel.ControllerName = "FastJV";
                    }
                    else
                    {
            ...
            try
            {
                if (!string.IsNullOrWhiteSpace(bookvou))
                {
                    ...
                    if (vcmvou == 0)
                        ...
                        flg = 2;
                    string value = ObjDBConnection.GetClosBalance(DbConnection.ParseInt32(bookvou), companyId, YearId, dtn, vcmvou, flg, "FJV", grdAmt);
                    return Json(new { response = true, message = value });
                }
            }
            catch (Exception ex)
        ...
        public IActionResult ExportToExcelPDF(int gridMstId, string searchValue, int type)
        {
            ...
            try
            {
                ...
                if (type == 1)
                {
                    var bytes = Excel(getReportDataModel, "Fast JV Report", companyDetails.CmpName);
                    return File(
                          bytes,
                ...
                {
                    var bytes = PDF(getReportDataModel, "Fast JV Report", companyDetails.CmpName);
                    return File(
                          bytes,
                          "application/pdf",
                          "FastJV.pdf");
