#pragma checksum "J:\PROJECTS\JItubhai\Society Management-Git\SocietyManagementWeb\Views\Query\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d1ece0d71975d5ae2b9a170433b045c470274d19"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d1ece0d71975d5ae2b9a170433b045c470274d19", @"/Views/Query/Index.cshtml")]
    ...
    public class Views_Query_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 2 "J:\PROJECTS\JItubhai\Society Management-Git\SocietyManagementWeb\Views\Query\Index.cshtml"
...
<div class=""col-md-12"">
    <div class=""card card-primary"">
        ...
        <div class=""card-body"">
            ...
            <div class=""row mt-3 d-none"" id=""AddNewQueryDi");
            WriteLiteral(@"v"">
                ...
                <div class=""col-12"">
                    <div class=""col-6"">
                        <div class=""form-group mb-2"">
                            ...
                            <i");
            WriteLiteral(@"nput type=""text"" class=""form-control"" id=""txtTitle"" />
                        </div>
                    </div>
                </div>
                <div class=""col-12"">
            ...
            WriteLiteral(@"bel""> Flag : <span class=""text-danger"">*</span></label>
...
<script>
            ...
            WriteLiteral(@" undefined) {
                    ...
                    if (response.rowsList != null && response.rowsList != '' && response.rowsList != undefined && response.rowsList.length > 0) {
                        ...
                        for (var x = 0; x < response.rowsList.length; x++) {
                            ...
                            if (rowsList != null && rowsList != '' && rowsList != un");
            WriteLiteral(@"defined && rowsList.length > 0) {
                                rowsHTML += `<tr>`;
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response != null && response != '' && response != undefined) {
                    ...
                    $(");
            WriteLiteral(@"'#txtSuffix').val(response.querySufix)
   ...
   ");
            WriteLiteral(@"     var fields = $('#txtFields').val()
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response != null && response != '' && response != undefined) {
                    ...
                    $('#txtQueryCode').val(response.queryCode)
         ");
            WriteLiteral(@"           $('#txtQueryCode1').val(response.queryCode)
